...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ac-cider ack-and-a-half alert anaconda-mode anzu async auto-package-update avy beacon browse-kill-ring cider cider-spy cljdoc cljr-helm clojure-mode clojure-mode-extra-font-locking clojurescript-mode company company-anaconda company-flow company-go company-lsp counsel counsel-spotify crappy-jsp-mode crux csharp-mode csv-mode d-mode dash diff-hl diminish discover-my-major docker dockerfile-mode easy-kill editorconfig epl expand-region f feature-mode flx-ido flycheck flycheck-clj-kondo flycheck-clojure flycheck-color-mode-line geiser gh gh-md git-commit gitignore-mode grizzl go-mode go-projectile god-mode gotest groovy-mode guru-mode helm helm-core helm-ack helm-bundle-show helm-cider helm-cider-history helm-clojuredocs helm-company helm-descbinds helm-github-stars helm-helm-commands helm-git helm-package helm-projectile helm-spotify-plus hideshow-org ht idle-highlight-mode ivy jade-mode js-auto-beautify js2-mode less-css-mode log4j-mode lsp-ui lua-mode lv magit magit-popup markdown-mode marshal move-text mustache-mode nodejs-repl npm-mode nyan-mode operate-on-number ov php-mode playerctl prettier-js projectile protobuf-mode puppet-mode pythonic rainbow-delimiters rainbow-mode realgud restclient restclient-test restclient-helm rust-mode s scss-mode sesman smex smart-mode-line smartparens smartrep spotify swiper transient tss typescript-mode undo-tree volatile-highlights with-editor which-key yari yaml-mode zop-to-char)))
