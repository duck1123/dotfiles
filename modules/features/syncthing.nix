...
{
  flake = {
    types.generic.feature-options.${feature-name} =
      { lib, ... }:
      with lib;
      let
          ...
          type = types.submodule {
            options = {
              ...
              path = mkOption {
                ...
                default = null;
                description = "Path for this share (uses default from shares config if not set)";
              };
            };
          };
          default = { };
            ...
            services.syncthing =
              let
                ...
                shares = {
                  ...
                  sims4 = {
                    path = "${homeDir}/.steam/steam/steamapps/compatdata/1222670/pfx/drive_c/users/steamuser/Documents/Electronic Arts/The Sims 4";
                  };
                };
              in
              {
                  ...
                  folders =
                    attrsets.mapAttrs'
                      (
                        ...
                        in
                        attrsets.nameValuePair folderName folderConfig
                      )
                      (
                        attrsets.filterAttrs (
                          shareName: _: config.host.features.syncthing.shares.${shareName}.enable or false
                        ) shares
                      );
