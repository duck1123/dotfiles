{ ... }: {
  flake.modules.options.types = { lib, ... }:
    with lib;
    let
      ...
      home-manager-submodule = types.submodule {
        options = {
          enable = mkOption {
            type = types.bool;
            default = false;
      ...
      media-submodule = types.submodule {
        options = {
          enable = mkOption {
            type = types.bool;
            default = false;
      ...
      syncthing-submodule = types.submodule {
        options = {
          enable = mkOption {
            type = types.bool;
            default = false;
      ...
      android-submodule = types.submodule {
        options = {
          enable = mkOption {
            type = types.bool;
            default = false;
      ...
      nixos-submodule = types.submodule {
        options = {
          enable = mkOption {
            type = types.bool;
            default = false;
      ...
      featureSubmodule = types.submodule {
        options = {
    ...
    in {
      inherit android-submodule featureSubmodule home-manager-submodule
        hostSubmodule identitySubmodule media-submodule nixos-submodule
        simpleFeature syncthing-submodule;
    };
}
